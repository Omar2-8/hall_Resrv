...
namespace Hall_Reservation.Controllers
{
    public class RolessesController : Controller
    {
        ...
        {
              return View(await _context.Rolesses.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName")] Roless roless)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("RoleId,RoleName")] Roless roless)
        {
            if (id != roless.RoleId)
            {
                return NotFound();
        ...
        {
          return _context.Rolesses.Any(e => e.RoleId == id);
        }
    }
}
